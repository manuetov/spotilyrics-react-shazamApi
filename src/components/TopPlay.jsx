...
function TopPlay() {
  ...
  // efecto smooth when recharge view in the chrome
  // without dependency the view recharge on top
  // with an empty array dependency the view recharge on bottom
  useEffect(() => {
    ...
    <div ref={divRef} className="xl:ml-6 ml-0 xl:mb-0 mb-6 flex-1 xl:max-w-[500px] max-w-full flex flex-col">
      ...
      <div className="w-full flex flex-col mt-8">
        <div className="flex flex-row justify-between items-center">
          ...
          <Link to="/top-artists">
            <p className="text-gray-300 text-base cursor-pointer">Ver más</p>
          </Link>
        </div>
